...
class RestaurantOrderManagement:
    ...
    def __init__(self,root):
        self.root=root
        self.root.title("𓆉 ✿ Restaurant Management App (๑ᵔ⤙ᵔ๑)")
        ...
        ttk.Label(
            frame,
            text="Currency [̲̅$̲̅(̲̅ιοο̲̅)̲̅$̲̅] ",
            font=("Arial", 12)
        ).grid(
    ...
    def setup_background(self,root):
        ...
        original_image=tk.PhotoImage(file="potato.png")
    ...
    def place_order(self):
        ...
        for item, entry in self.menu_quatities.items():
            quantity=entry.get()
            if quantity.isdigit():
            ...
            if total_cost>0:
                ...
                messagebox.showinfo("Order Placed 𓎩𓌉", order_summary)
            else:
